...
public class CommentNewsthingInfo extends Commentator {
    ...
    private ArrayList<CommentNewsthingInfo> parentComments;
    private int vote_positive;

    public CommentNewsthingInfo() {
    }
    ...
    public ArrayList<CommentNewsthingInfo> getParentComments() {
        return parentComments;
    }

    public void setParentComments(ArrayList<CommentNewsthingInfo> parentComments) {
    ...
    public int compareTo(Object another) {
        String anotherTimeString = ((CommentNewsthingInfo) another).getDate();
